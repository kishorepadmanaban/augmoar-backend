...
$instance = new DuplicateTarget($targetId);
...
class DuplicateTarget{
	...
	private $requestPath = "/duplicates/";// . $targetId;
	private $request;

	function DuplicateTarget($id){

		$this->targetId = $id;

		$this->requestPath = $this->requestPath . $this->targetId;

		$this->execDuplicateTarget();
	}

	private function execDuplicateTarget(){
